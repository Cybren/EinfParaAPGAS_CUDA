...
#SBATCH --job-name=WS20_PV2_APGAS_Squares_seq
...
####### Output #######
#SBATCH --output=HOME/out/WS20-PV2-APGAS-Squares_seq-placesNUMPLACES-placesPerNodePPERNODE-threadsTHREADS.out.%j
#SBATCH --error=HOME/out/WS20-PV2-APGAS-Squares_seq-placesNUMPLACES-placesPerNodePPERNODE-threadsTHREADS.err.%j
...
java -cp .:HOME/workspaceWS20PV2APGAS/lib/* \
  ...
  group2.Squares_sequential 100 10 42 3 10 0
