...
#SBATCH --job-name=WS20_PV2_APGAS_HelloWorld
...
####### Output #######
#SBATCH --output=HOME/out/WS20-PV2-APGAS-HelloWorld-placesNUMPLACES-placesPerNodePPERNODE-threadsTHREADS.out.%j
#SBATCH --error=HOME/out/WS20-PV2-APGAS-HelloWorld-placesNUMPLACES-placesPerNodePPERNODE-threadsTHREADS.err.%j
